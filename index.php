    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">I guess we'll to start by explaining
          what a power hour is. Look at the pretty diagram below. </h3>
          <h3 class="section-subheading text-muted">This application was made to fill in
          for the need of video power hours on the web. Don't you want something
